...
def preprocess_input(input_data):
    ...
    training_column_order = ['amt', 'lat', 'long', 'city_pop', 'merch_lat', 'merch_long', 
                             ...
                             'city_Albuquerque', 'city_Alva', 'city_Athena', 'city_Azusa', 'city_Ballwin', 
                             ...
                             'city_Mesa', 'city_Moab', 'city_Mound-City', 'city_Newhall', 'city_North-Loup', 'city_Orient', 'city_Paauilo', 'city_Parks', 'city_Phoenix', 
                             ...
                             'state_AK', 'state_AZ', 'state_CA', 'state_CO', 'state_HI', 'state_ID', 'state_MO', 'state_NE', 'state_NM',
                             'state_OR', 'state_UT', 'state_WA', 'state_WY'
                            ]
...
def main():
    ...
    if st.sidebar.button('Predict'):
        ...
        prediction_text = "Not Fraud Txn" if prediction[0] == 1 else "Fraud Txn"
